...
public class MJCTSystemLoader {
	...
	private MJCTSystemLoader(){
		_objs = new HashMap<>(64);
		ArrayList<MJCTObject> ctl	= new ArrayList<>(256);
		MJCTObject			obj		= null;
		Connection 			con		= null;
		PreparedStatement 	pstm	= null;
		ResultSet 			rs		= null;
	...
	public ArrayList<MJCTObject> getValues(){
		...
		synchronized(_lock){
			list = new ArrayList<>(_objs.values());
		}
		return list;
	}
	...
	private void store(){
		...
		ArrayList<MJCTObject> list 	= new ArrayList<>(_objs.values());
		int 				size 	= list.size();
		Connection 			con		= null;
		PreparedStatement 	pstm	= null;
		MJCTObject			obj		= null;
