	...
	public static void stopSkill(L1Character cha, int skillId) {
		switch (skillId) {
			...
			case TITAN_RISING: {
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.TITAN_RISING, false, -1), true);
			...
			case DEATH_HEAL: {
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_CreateItem( DEATH_HEAL, 1));
				}
			}
			...
			case PRIDE:
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.PRIDE, false, -1), true);
					pc.sendPackets(new S_SystemMessage("You feel the effect of Pride fade away."));
					if (pc.isInParty()) {
			...
			case BLOWATTACK:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.BLOWATTACK, false, -1), true);
					pc.sendPackets(new S_SystemMessage("You feel the effect of Blow Attack fade away."));
				}
				break;
			...
			case IMMUNE_TO_HARM:// 15
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SystemMessage("Immune to Harm effect has worn off."));
				}
				break;
			...
			case BURNING_SPIRIT:// 15
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SystemMessage("Burning Spirit effect has worn off."));
				}
				break;
			...
			case ELEMENTAL_FIRE:// 15
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SystemMessage("Elemental Fire's effect has worn off."));
				}
				break;
			...
			case GIGANTIC:
				if (cha instanceof L1PcInstance) {
					...
					pc.setggHp(0);
					pc.sendPackets(new S_HPUpdate(pc.getCurrentHp(), pc.getMaxHp()),true);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.GIGANTIC, false, -1), true);
					if (pc.isInParty()) {
						pc.getParty().updateMiniHP(pc);
					}
				}
			...
			case AWAKEN_LINDVIOR:
				if (cha instanceof L1PcInstance) {
					...
					pc.addDg(-7);
					pc.sendPackets(new S_OwnCharAttrDef(pc));
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.AWAKEN_LINDVIOR, false, -1), true);
			...
			case DECREASE_WEIGHT: // wizard
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.addWeightReduction(-Config.DECREASE_WEIGHT_VALUE);
				}
				break;
			/*case ELVEN_GRAVITY: // elf
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.addWeightReduction(-300);
				}
				break;*/
			case REDUCE_WEIGHT: // illusionist
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.addWeightReduction(-Config.REDUCE_WEIGHT_VALUE);
				}
				break;
			case SLOW:
				if (cha instanceof L1PcInstance) {
			...
			case ABSOLUTE_BLADE:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.ABSOLUTE_BLADE, false, -1), true);
					pc.sendPackets(new S_SystemMessage("Absolute Blade's effect has faded away."));
				}
				break;
			...
			case MOBIUS:
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SystemMessage("Mobius' effect has worn off."));
				}
				break;
			...
			case MAJESTY:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.MAJESTY, false, -1), true);
					pc.sendPackets(new S_SystemMessage("Majesty's effect has worn off."));
				}
				break;
			...
			case SHINING_ARMOUR:
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_CharVisualUpdate(pc));
					pc.sendPackets(new S_PacketBox(S_PacketBox.char_ER, pc.get_PlusEr()), true);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.SHINING_ARMOUR, false, -1), true);
				}
				break;
			...
			case FOCUS_SPIRIT:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.addDmgup(-5);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.FOCUS_SPIRIT, false, -1), true);
			...
			case ENCHANT_ACCURACY:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.addHitup(-5);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.ENCHANT_ACCURACY, false, -1), true);
					pc.sendPackets(new S_SystemMessage("You feel the effect of Enchant Accuracy fade away."));
				}
				break;
			...
			case FREEZING_ARMOUR:
				if (cha instanceof L1PcInstance) {
					...
					pc.Add_Er(-5);
					pc.sendPackets(new S_PacketBox(S_PacketBox.char_ER, pc.get_PlusEr()), true);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.FREEZING_ARMOUR, false, -1), true);
					pc.sendPackets(new S_SystemMessage("You feel the effect of Freezing Armour fade away."));
				}
				break;
			...
			case 강화버프_홀드: // Enhanced Buff_Hold
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
				}
				break;
			...
			case BRAVE_MENTAL:
				...
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.BRAVE_MENTAL, false, -1), true);
				}
				break;
			...
			case CLEAR_MIND:
				...
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SystemMessage("The you feel the magic of Clear Mind return to nature."));
				}
				break;
			...
			case AWAKEN_ANTHARAS:
				if (cha instanceof L1PcInstance) {
					...
					pc.getAC().addAc(3);
					pc.sendPackets(new S_OwnCharAttrDef(pc), true);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.AWAKEN_ANTHARAS, false, -1), true);
			...
			case AWAKEN_FAFURION:
				if (cha instanceof L1PcInstance) {
					L1PcInstance pc = (L1PcInstance) cha;
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.AWAKEN_FAFURION, false, -1), true);
			...
			case AWAKEN_VALAKAS:
				if (cha instanceof L1PcInstance) {
					...
					pc.addHitup(-5);
					pc.sendPackets(new S_NewSkillIcons(L1SkillId.AWAKEN_VALAKAS, false, -1), true);
			...
			case MISO_1_ATT: {
				if (cha instanceof L1PcInstance) {
					...
					pc.sendPackets(new S_SPMR(pc));
					pc.sendPackets(new S_OwnCharAttrDef(pc));
					pc.sendPackets(new S_MaanIcons(L1SkillId.MISO_1_ATT, false, 0));
				}
			}
				break;
			case MISO_2_DEF: {
