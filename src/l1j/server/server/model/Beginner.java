		...
		try {
			...
			while (rs.next()) {
				try {
					...
					if ((itemid >= 425000 && itemid <= 425002) || // Elmore Armor
							(itemid >= 450000 && itemid <= 450007)) { // Elmore Weapon
						deleteTime = new Timestamp(System.currentTimeMillis() + (3600000 * 24 * 3)); // 3day
							...
							|| itemid == 224) {
						deleteTime = new Timestamp(System.currentTimeMillis() + (3600000 * 24 * 7)); // 3day
					}
