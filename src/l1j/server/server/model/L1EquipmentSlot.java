...
public class L1EquipmentSlot {
	...
	private void setWeapon(L1ItemInstance weapon, boolean doubleweapon) {
		...
		if (weapon.getItemId() == 261) { // Meditation Wand
			_owner.addMpr(weapon.getEnchantLevel());
		}
		/** Claudia's Silver Sword and Silver Axe Quest Completion Part */
		if ((weapon.getItemId() == 29 || weapon.getItemId() == 142) && _owner.getLevel() > 1 && _owner.getLevel() <= Config.CLAUDIALEVEL) {
	...
	private void setArmor(L1ItemInstance armor, boolean loaded) {
		...
		if ((itemtype >= 8 && itemtype <= 12) || itemtype == 16 || itemtype == 20 || itemtype == 21) { // Add crests and insignia
		...
		if (itemId == 130220) { // Gloves of Frenzy
			switch (itemlvl) {
			case 7:
				_owner.addHitup(4);
				break;
		...
		if (itemgrade == 3 && itemId == 30036) { // Warrior's Pendant
			double perhp = itemlvl < 7 ? ((2.000 + (itemlvl * 2.000))) / 100 : (((itemlvl * 3.000) - 4.000)) / 100;
			double permp = itemlvl < 8 ? ((1.000 + (itemlvl))) / 100 : ((2.000 + (itemlvl))) / 100;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 0:
		...
		//Blessed fighter pendant added
		if (itemgrade == 3 && itemId == 30040) { // Fighter's Pendant (Blessing)
			double perhp = itemlvl < 5 ? ((4.000 + (itemlvl * 2.000))) / 100 : (((itemlvl * 3.000) - 1.000)) / 100 ;
			double permp = itemlvl < 8 ? ((1.000 + (itemlvl))) / 100 : ((6.000 + (itemlvl))) / 100 ;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 1:
		...
		if (itemgrade == 3 && itemId == 30034) { // Lumtis's Light Bow Pendant
			double perhp = itemlvl < 3 ? ((1.000 + (itemlvl))) / 100 : (((itemlvl * 2.000) - 1.000)) / 100;
			double permp = itemlvl < 3 ? ((1.000 + (itemlvl))) / 100 : (((itemlvl * 2.000) - 1.000)) / 100;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 0:
		...
		if (itemgrade == 3 && itemId == 30039) { // Blessed Lumtis's Light Bow Pendant
			double perhp = itemlvl < 8 ? (((itemlvl * 2.000) + 1.000)) / 100 : (((itemlvl * 2.000) + 2.000)) / 100;
			double permp = itemlvl < 8 ? (((itemlvl * 2.000) + 1.000)) / 100 : (((itemlvl * 2.000) + 2.000)) / 100;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 1:
...
//추가끝
		...
		if (itemgrade == 3 && itemId == 30037) { // 현자의 팬던트
			double perhp = itemlvl < 8 ? ((1.000 + (itemlvl))) / 100 : ((2.000 + (itemlvl))) / 100;
			double permp = itemlvl < 7 ? ((2.000 + (itemlvl * 2.000))) / 100 : (((itemlvl * 3.000) - 4.000)) / 100;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 0:
		...
		if (itemgrade == 3 && itemId == 30041) { // 현자의 팬던트(축복)
			double perhp = itemlvl < 8 ? ((1.000 + (itemlvl))) / 100 : ((6.000 + (itemlvl))) / 100 ;
			double permp = itemlvl < 5 ? ((4.000 + (itemlvl * 2.000))) / 100 : (((itemlvl * 3.000) - 1.000)) / 100 ;
			int addhp = (int) (_owner.getBaseMaxHp() * perhp);
			int addmp = (int) (_owner.getBaseMaxMp() * permp);
			switch (itemlvl) {
			case 1:
...
//추가끝
		...
		if (itemId == 27528 || itemId == 27529 || itemId == 27530) { // Halpas Armor Reduction
			if (itemlvl == 0) {
		...
		if (RegistLevel == 10) { // Pandora Spirit Glyph
		...
		} else if (RegistLevel == 11) { // Pandora Mana Glyph
			_owner.addMaxMp(30);
		} else if (RegistLevel == 12) { // Pandora Stamina Glyph
			_owner.addMaxHp(50);
		} else if (RegistLevel == 13) { // Pandora Extermination Glyph
			_owner.getResistance().addMr(10);
		} else if (RegistLevel == 14) { // Pandora Steel Glyph
			_owner.getAC().addAc(-1);
		} else if (RegistLevel == 15) { // Pandora Restoration Glyph
			_owner.addHpr(1);
			_owner.addMpr(1);
		}
		...
		_owner.set문장레벨(crestOfGrowthLvl(itemId, itemlvl));
	...
	private void removeWeapon(L1ItemInstance weapon, boolean doubleweapon) {
		...
		if (_owner.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.COUNTER_BARRIER)) {
			...
			_owner.sendPackets(new S_SMPacketBox(S_SMPacketBox.RMSkillIconAura, L1SkillId.COUNTER_BARRIER, 0), true);
		...
		} else if (_owner.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.SANDSTORM)) {
			_owner.getSkillEffectTimerSet().removeSkillEffect(L1SkillId.SANDSTORM);
	...
	private void removeArmor(L1ItemInstance armor) {
		...
		if (itemId == 21097) { // Sorcerer's Guard
			switch (itemlvl) {
			case 5:
			case 6:
				_owner.getAbility().addSp(-1);
		...
		if (itemId == 21095) { // guard of stamina
			switch (itemlvl) {
			case 5:
			case 6:
				_owner.addMaxHp(-25);
		...
		if (itemId == 21096) { // guardian guard
			switch (itemlvl) {
			case 5:
			case 6:
				_owner.addDamageReductionByArmor(-1);
		...
		if (armor.getAttrEnchantLevel() > 0) { // reduction
			switch (armor.getAttrEnchantLevel()) {
			case 41:
				_owner.addDamageReductionByArmor(-1);
				break;
		...
		if (itemtype >= 8 && itemtype <= 12) {
			if (itemlvl > 0) {
				...
				if (itemgrade == 3 && itemId == 21246) { // 지혜의반지
				...
				} else if (itemgrade == 3 && itemId == 21249) { // Snappers Warrior Ring
					switch (itemlvl) {
					case 1:
						_owner.getAC().addAc(1);
						break;
					...
					/** Blessed Snapper's Ring of Wisdom **/
				} else if (itemgrade == 3 && itemId == 21250) {
					switch (itemlvl) {
					case 1:
						_owner.addMaxHp(-5);
					...
					/** Blessed Snapper's Champion's Ring **/
				} else
	...
	public void setMagicHelm(L1ItemInstance item) {
		...
		case 120013:
			...
			_owner.setSkillMastery(HASTE);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, PHYSICAL_ENCHANT_DEX, true), true);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, HASTE, true), true);
			break;
		case 20014:
		case 120014:
			_owner.setSkillMastery(HEAL);
			_owner.setSkillMastery(EXTRA_HEAL);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, HEAL, true), true);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, EXTRA_HEAL, true), true);
			break;
		case 20015:
		case 120015:
			...
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, PHYSICAL_ENCHANT_STR, true), true);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, DETECTION, true), true);
			_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, ENCHANT_WEAPON, true), true);
			break;
		case 20023:
	...
	public void removeMagicHelm(int objectId, L1ItemInstance item) {
		...
		case 120013:
			if (!SkillsTable.getInstance().spellCheck(objectId, PHYSICAL_ENCHANT_DEX)) {
				...
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, PHYSICAL_ENCHANT_DEX, false), true);
			}
			if (!SkillsTable.getInstance().spellCheck(objectId, HASTE)) {
				_owner.removeSkillMastery(HASTE);
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, HASTE, false), true);
			}
			break;
		case 20014:
		case 120014:
			if (!SkillsTable.getInstance().spellCheck(objectId, HEAL)) {
				...
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, HEAL, false), true);
			}
			if (!SkillsTable.getInstance().spellCheck(objectId, EXTRA_HEAL)) {
				_owner.removeSkillMastery(EXTRA_HEAL);
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, EXTRA_HEAL, false), true);
			}
			break;
		case 120015:
		case 20015:
			if (!SkillsTable.getInstance().spellCheck(objectId, ENCHANT_WEAPON)) {
				...
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, ENCHANT_WEAPON, false), true);
			}
			if (!SkillsTable.getInstance().spellCheck(objectId, DETECTION)) {
				_owner.removeSkillMastery(DETECTION);
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, DETECTION, false), true);
			}
			if (!SkillsTable.getInstance().spellCheck(objectId, PHYSICAL_ENCHANT_STR)) {
				_owner.removeSkillMastery(PHYSICAL_ENCHANT_STR);
				_owner.sendPackets(new S_NewAddSkill(S_NewAddSkill.ADD_SKILL_NEW, _owner, PHYSICAL_ENCHANT_STR, false), true);
			}
			break;
		case 20023:
	...
	public int crestOfGrowthLvl(int itemid, int itemlvl) {
		if (itemid == 490020) { // Crest of Growth
			if (itemlvl <= 6)
				return itemlvl + 1;
			switch (itemlvl) {
			case 7:
