...
public class L1NpcChatTimer extends TimerTask {
	...
	public void run() {
		try {
			if (_npc == null || _npcChat == null || _npc.getHiddenStatus() != L1NpcInstance.HIDDEN_STATUS_NONE
					|| _npc._destroyed) {
				return;
			}
	...
	private void chat(L1NpcInstance npc, int chatTiming, String chatId,
		...
		if ((chatTiming == L1NpcInstance.CHAT_TIMING_APPEARANCE && npc.isDead()) || (chatTiming == L1NpcInstance.CHAT_TIMING_DEAD && !npc.isDead())) {
			return;
		}
