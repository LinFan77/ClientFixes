...
//					os.writeH(16);  //마법 방어 + 16
			...
			/** Normal Necklace Earring Announcement Reduction Potion Efficiency Display **/
			if (getItem().getGrade() != 3 && itemType2 == 2
					&& (getItem().getType() == 8 || getItem().getType() == 12)) {
				switch (getEnchantLevel()) {
				case 5:
					os.writeC(96);
					os.writeC(3); // Healing reduction Defense 1%
					break;
				case 6:
					os.writeC(96);
					os.writeC(5); // Healing reduction Defense 1%
					break;
				case 7:
					os.writeC(96);
					os.writeC(7); // Healing reduction Defense 1%
					break;
				case 8:
					os.writeC(96);
					os.writeC(9); // Healing reduction Defense 1%
					break;
				case 9:
					os.writeC(96);
					os.writeC(10); // Healing reduction Defense 1%
					break;
				default:
					break;
				}
			...
			} else if (itemId == 500008) { // Rumtis Blue Earring
				switch (getEnchantLevel()) {
				case 0:
					os.writeC(65);
					os.writeC(2);
...
*/
			...
			*/
			...
			if (itemType2 == 1) {
				...
				if(getItem().getType1() != 20 && getItem().getType1() != 62){
					/** If it is a weapon type and the item is Bless, give it a demon mark */
					if (getItem().getBless() == 0){
						os.writeC(115);
						os.writeD(1);
					}

					/** Weapon damage check effect No damage mark for bow series */
		...
		/** Check all items and if it is a non-tradable item, the warehouse is disabled */
		/** Indicates non-tradeable warehouses*/
		os.writeC(130);
