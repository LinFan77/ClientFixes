...
public class L1Inventory extends L1Object {
	...
	public boolean remove_craft(int itemid, int count, int enchant) {
		if ((count <= 0) || (itemid == 0 && count == 0 && enchant == 0)) {
			return false;
		}
				...
				try {
					if (this instanceof L1PcInventory) {
						...
						String 소지자 = in.getOwner() != null ? in.getOwner()
								.getName() : "없음";
						_log.info("L1Inventory removeItem - item Request and process more than the number -holders:"
								+ 소지자
								+ " item:"
								+ item.getLogName()
								+ " Number of requests:"
