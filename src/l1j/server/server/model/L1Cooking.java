...
public class L1Cooking {
	...
	public static void useNewCookingItem(L1PcInstance pc, L1ItemInstance item) {
		...
		case 60726:
			...
			break;
		case 60259:
			cookingId = SPICY_RAMEN;
			break;
		case 60260:
			cookingId = PSY_COOL_DRINK;
			break;
		...
		if (cookingId == METIS_CUISINE || cookingId == SPICY_RAMEN || cookingId == PSY_COOL_DRINK)
			newEatCooking(pc, cookingId, 920);
		else if (cookingId == METIS_SOUP)
			newEatCooking(pc, cookingId, 900);
		else
			newEatCooking(pc, cookingId, 1800);
		if (cookingId != SPICY_RAMEN && cookingId != PSY_COOL_DRINK)
	...
	public static void newEatCooking(L1PcInstance pc, int cookingId, int time) {
		...
		int cookingId2 = 0;
		if (cookingId == COOKING_NEW_닭고기 || cookingId == METIS_SOUP || cookingId == PSY_COOL_DRINK || cookingId == 천하장사버프 || cookingId == COOKING_NEW_탐닭고기)
