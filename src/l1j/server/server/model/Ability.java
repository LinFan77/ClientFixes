...
public class Ability {
	...
	private byte str; // Base strength + increased strength from leveling up or elixir
	private byte baseStr; // base STR
	private byte addedStr; // Power raised by magic or items
