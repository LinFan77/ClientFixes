  ...
  private void BossSpawn(){
    try{
      int i = rnd.nextInt(4);
        ...
        L1World.getInstance().broadcastServerMessage("\\aF기란감옥 1층 어딘가에 두목 선물도둑이 나타났습니다.");
        L1World.getInstance().broadcastPacketToAll(new S_PacketBox(84, "\\aF기란감옥 1층 어딘가에 두목 선물도둑이 나타났습니다."));
    } catch (Exception e) {
     e.printStackTrace();
    }
  }
