...
public class S_LoginResult extends ServerBasePacket {
	...
	// 06-The same character already exists 9-Wrong name
	// 24-IP limit system 26-Virtual IP multiple access
	// 28-Change your password 29-Question and answer 31-Account transfer
	// 32-There is no time left 34-Use of this character is prohibited
	// 35-Unable to change password in game 36-Stop due to charge problem
	// 37-Report theft 38-Bug use van 39-Current transaction van
