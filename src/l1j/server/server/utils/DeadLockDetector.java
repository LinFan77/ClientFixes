...
public class DeadLockDetector implements Runnable {
		...
		try {
			...
			if (threadIds != null) {
				if (pc != null && pc.getNetConnection() != null)
					pc.sendPackets(new S_SystemMessage("Deadlock detection! See Server Console"));
				else
				...
				if (pc != null && pc.getNetConnection() != null)
					pc.sendPackets(new S_SystemMessage("No deadlock."));
				else
	...
	private void printMonitorInfo(ThreadInfo threadInfo,
		...
		sb.append(INDENT + "locked monitor: " + monitorInfos.length + "dog\n");
	...
	private void printLockInfo(LockInfo[] lockInfos) {
		sb.append(INDENT + "Locked Sink: " + lockInfos.length + "dog\n");
