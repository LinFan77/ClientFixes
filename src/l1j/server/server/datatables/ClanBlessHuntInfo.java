...
public class ClanBlessHuntInfo {
	...
	private Map<Integer, HuntInfo> _huntList = new HashMap<>();
	...
	private ClanBlessHuntInfo() {
		TimeLine.start("[ClanBlessHuntInfo] loading...");
	...
	public void reload() {
		TimeLine.start("[ClanBlessHuntInfo]...");

		Map<Integer, HuntInfo> huntList = new HashMap<>();
		load(huntList);
		_huntList = huntList;
	...
	public class HuntInfo {
		private int _id;
		private ArrayList<Integer> _maplist = new ArrayList<>();
