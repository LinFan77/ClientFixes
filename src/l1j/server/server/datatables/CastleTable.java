...
public class CastleTable {
	...
	public static Calendar timestampToCalendar(LocalDateTime localDateTime) {
	...
	private void load() {
		...
		System.out.print("[CastleTable] loading...");
		Connection con = null;
		...
		try {
			...
			while (rs.next()) {
				...
				castle.setWarTime(timestampToCalendar(rs.getObject(3, LocalDateTime.class)));
