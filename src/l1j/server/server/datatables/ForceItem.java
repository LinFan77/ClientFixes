...
public final class ForceItem {
	...
	private final Map<Integer, Integer> _itempercent = new HashMap<>();

	private final Map<Integer, Integer> _succitem = new HashMap<>();
	...
	private void SuccPercent() {
		...
		try {
			...
			for (rs = pstm.executeQuery(); rs.next();) {
				...
				_itempercent.put(itemId, SuccPercent);
			}
