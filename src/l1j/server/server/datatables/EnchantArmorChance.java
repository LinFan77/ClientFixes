...
public class EnchantArmorChance {//enchant_armor_chance
	...
	private final FastMap<String, L1EnchantArmorChance> _armorName = new FastMap<>();
	private final FastMap<Integer, L1EnchantArmorChance> _armorIdList = new FastMap<>();
	...
	private EnchantArmorChance() {
		System.out.print("Loading armour enchant data...");
		load();
	...
	private void fillTable(ResultSet rs) throws SQLException {
		...
		_log.config("Armor enchantment list " + _armorName.size() + " gun load");
		SQLUtil.close(rs);
	}
