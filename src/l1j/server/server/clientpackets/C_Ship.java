	...
	public C_Ship(byte abyte0[], LineageClient client) {
		...
		try {
			...
			case 1700:
				break;
			default:
				System.out.println("Bug with repeater to move specific coordinates> " + pc.getName() + " Current Map> " + mapId + " x>" + pc.getX() + " y>" + pc.getY());
				System.out.println("Movement Attempt Map>" + shipMapId + " x>" + locX + " y>" + locY);
				return;
			}
