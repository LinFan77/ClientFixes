...
public class L1Shutdown implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (arg.equalsIgnoreCase("1hour")) {
				GameServer.getInstance().saveAllCharInfo();
				GameServer.getInstance().shutdownWithCountdown(3600);
				return;
			}
			...
			pc.sendPackets(new S_SystemMessage("GMC Error: Please use .shutdown [now/stop]"));
		}
	}
}
