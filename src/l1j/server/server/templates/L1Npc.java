...
public class L1Npc extends L1Object implements Cloneable {
	...
	public void set_NameUSA(String name) {
		_nameUSA = name;
	}

	public String get_NameUSA() {
		return _nameUSA;
	}

	private String _nameKorea;

	public void set_NameKorea(String name) {
		_nameKorea = name;
	}

	public String get_NameKorea() {
		return _nameKorea;
	}

	private String _nameJapan;

	public void set_NameJapan(String name) {
		_nameJapan = name;
	}

	public String get_NameJapan() {
		return _nameJapan;
	}

	private String _nameChina;

	public void set_NameChina(String name) {
		_nameChina = name;
	}
