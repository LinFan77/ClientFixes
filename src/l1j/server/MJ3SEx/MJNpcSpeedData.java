...
public class MJNpcSpeedData {
	...
	public static void do_load(){
		HashMap<Integer, MJNpcSpeedData> npc_speed_data = new HashMap<>();
	...
	private static MJNpcSpeedData newInstance(ResultSet rs) throws SQLException{
		return newInstance().set_monster_id(rs.getInt("monster_id"))
				.set_speed(rs.getInt("speed")).set_brave(rs.getInt("brave"));
	}
