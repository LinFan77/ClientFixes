...
public class NpcShopSystem implements TimeListener {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					while (count-- > 0) {
						...
						for (L1Object obj : objlist) {
							if ((obj.getX() == x && obj.getY() == y) || (obj.getLocation().getTileLineDistance(
	...
	private static ArrayList<L1NpcInstance> _shops = new ArrayList<>(256);
	...
	public void npcShopStart() {
		...
		System.out.print("[NpcShopStart] loading...");
