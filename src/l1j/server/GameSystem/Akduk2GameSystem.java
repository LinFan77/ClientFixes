			...
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1BuffNpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 7000068) {
						...
						String chat = "Sir " + player.getName() + " has placed a bet of " + bettingmoney + " adena! Every time you hit one, it doubles!";
						...
						Thread.sleep(1000);
						Thread.sleep(1000);
						String chat2 = "Odd or even 1 to 6 digits x2 x3 Please enter odd or even number.";
		...
		try {
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1BuffNpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 7000068) {
						L1BuffNpcInstance dealer = Npc;
						String chat9 = pc.getName() + "You got it right!" + pc.getGamblingMoney() * 2 + "원 지급했습니다.";
						String chat10 = pc.getName() + "You got it right!" + pc.getGamblingMoney() * 3 + "원 지급했습니다.";
						String chat11 = pc.getName() + "You got it wrong!";
						...
						case 1:
							Thread.sleep(2000);
							String chat = pc.getName() + "You have chosen the hall. If you go too far, the game will be canceled.";
						...
						case 2:
							Thread.sleep(2000);
							String chat2 = pc.getName() + "You have chosen a pair. If you go too far, the game will be canceled.";
						...
						case 3:
							Thread.sleep(2000);
							String chat3 = pc.getName() + "You have selected 1. If you go too far, the game will be canceled.";
						...
						case 4:
							Thread.sleep(2000);
							String chat4 = pc.getName() + "You have selected 2. If you go too far, the game will be canceled.";
						...
						case 5:
							Thread.sleep(2000);
							String chat5 = pc.getName() + "You have selected 3. If you go too far, the game will be canceled.";
						...
						case 6:
							Thread.sleep(2000);
							String chat6 = pc.getName() + "You have selected 4. If you go too far, the game will be canceled.";
						...
						case 7:
							Thread.sleep(2000);
							String chat7 = pc.getName() + "You have selected 5. If you go too far, the game will be canceled.";
						...
						case 8:
							Thread.sleep(2000);
							String chat8 = pc.getName() + "You have chosen 6. If you go too far, the game will be canceled.";
