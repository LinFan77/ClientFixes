...
public class Robot_Location {
	...
	private static ArrayList<Robot_Location_bean> 기란셋팅 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기란셋팅2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기란셋팅3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기란셋팅4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기란셋팅5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오렌셋팅 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 글말셋팅 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 웰던셋팅 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 텔녀6 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던입구 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던입구 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기감입구 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 상아탑4층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 상아탑5층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용계1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용계2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용계3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용계4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용계5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 자이언트밭1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 자이언트밭2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 화둥1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 화둥2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 화둥3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 화둥4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 화둥5 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 풍둥1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 풍둥2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 풍둥3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 풍둥4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 풍둥5 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 지하침공로1층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 지하침공로1층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 지하침공로2층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 지하침공로2층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 지하침공로3층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 지하침공로3층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 에바1층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 에바1층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 에바2층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 에바2층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 에바3층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 에바3층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 에바4층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 에바4층2 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 하이네잡밭 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 하이네잡밭2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 하이네잡밭3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 하이네잡밭4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 하이네잡밭5 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 오만10층1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층6 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만10층7 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 오만9층1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층6 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층7 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층8 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층9 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만9층10 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 오만8층1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층6 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층7 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 오만8층8 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 지저 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던1층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던2층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던3층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던4층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던5층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던6층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 용던7층 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 본던1층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던2층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던3층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던4층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던5층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던6층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 본던7층 = new ArrayList<>();


	private static ArrayList<Robot_Location_bean> 선박심해 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 선박심해2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 선박심해3 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 잊섬2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 잊섬3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 잊섬4 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 개미굴1 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 개미굴2 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 개미굴3 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 개미굴4 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 개미굴5 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 개미굴6 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 기감1층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기감2층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기감3층 = new ArrayList<>();
	private static ArrayList<Robot_Location_bean> 기감4층 = new ArrayList<>();

	private static ArrayList<Robot_Location_bean> 결계1층 = new ArrayList<>();

	public static void locationRegistration(int x, int y, int m) {
