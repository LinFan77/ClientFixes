	...
	public void run() {
		...
		try {
			...
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.GLOWING_WEAPON,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(npc1.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.SHINING_SHIELD,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Thread.sleep(1000L);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.BRAVE_MENTAL,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Thread.sleep(1000L);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
			...
			new L1SkillUse().handleCommands(_pc,
					L1SkillId.ILLUSION_GOLEM, _pc.getId(), _pc.getX(),
