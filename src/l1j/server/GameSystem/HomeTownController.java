...
public class HomeTownController {
	...
	public void dailyProc() {
		_log.info("Home town system: Daily processing start");
	...
	public void monthlyProc() {
		_log.info("Home town system: Start of month processing");
		L1World.getInstance().setProcessingContributionTotal(true);
		for (L1PcInstance pc : L1World.getInstance().getAllPlayers()) {
			try {
				pc.save(); // Write character info to DB
			} catch (Exception e) {
