		...
		try {
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1BuffNpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 7000078) {
						L1BuffNpcInstance dealer = Npc;
						String chat9 = pc.getName() + "님 고수시군요? 배당금 지급해드렸습니다.";
						String chat10 = pc.getName() + "님 비기셨네요. 아쉽네요 ㅜㅜ";
						String chat11 = pc.getName() + "님 허접이군요? 다시배워서오세요~";
